...
public class Students {
    ...
    void printNote(){
        System.out.println("-------------------------------------------------");
        System.out.println(this.c1.name+" Sınav notunuz :\t :"+this.c1.note+"\nSözlü Notu\t :"+this.c1.noteS);
        System.out.println("-------------------------------------------------");
        System.out.println(this.c2.name+" Sınav notunuz :\t :"+this.c2.note+"\nSözlü Notu\t :"+this.c2.noteS);
        System.out.println("-------------------------------------------------");
        System.out.println(this.c3.name+" Sınav notunuz :\t :"+this.c3.note+"\nSözlü Notu\t :"+this.c3.noteS);
        System.out.println("-------------------------------------------------");
